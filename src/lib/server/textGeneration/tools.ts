...
export async function* runTools(
	...
	const toolCallGenerators = calls.map((call) => callTool(toolContext, tools, call));
	const toolResults: (ToolResult | undefined)[] = yield* mergeAsyncGenerators(toolCallGenerators);
